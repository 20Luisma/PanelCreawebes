...
- **Estado actual:** Proyecto 100% migrado a Clean Architecture. Estructura limpia en la raíz. Credenciales en `.env`. Listo para deploy (pendiente decisión de Martín).
