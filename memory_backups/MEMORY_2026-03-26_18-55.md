...
- **Bugfix Notificaciones Chat Offline:** Diagnóstico de una falla silenciosa JS donde los mensajes offline se consumían en la nada por ausencia de las cajas DOM. Se restituyeron los contenedores `<audio>` y los popups en `modales.php`, recuperando el 100% de las alertas de chat diferido.
